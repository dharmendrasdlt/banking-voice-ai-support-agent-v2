...
func (q *QdrantManager) SeedData(ctx context.Context, ollamaClient *ollama.Client) error {
	...
	actions := []ActionSeed{
		...
		{Text: "what are my two last transactions", Intent: "transactions", ResponseTemplate: "Here are your recent transactions: {{transactions}}.", BankAction: "get_transactions"},
		{Text: "what are my last 2 transactions", Intent: "transactions", ResponseTemplate: "Here are your recent transactions: {{transactions}}.", BankAction: "get_transactions"},
